...
import { Activity, MessageSquare, Target, LayoutDashboard, Radar, Briefcase, Bot, Zap, List, BrainCircuit } from 'lucide-react';
...
const navItems = [
    ...
    { href: '/ml/overview', label: 'ML Desk', icon: BrainCircuit },
];
